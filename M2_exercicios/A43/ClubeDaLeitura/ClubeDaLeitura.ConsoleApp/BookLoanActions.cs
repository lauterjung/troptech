...
namespace ClubeDaLeitura
{
    public static class BookLoanActions
    {
        ...
        public static void Menu()
        {
            ...
            Console.WriteLine("[2] Buscar todos os Emprestimos");
            Console.WriteLine("[3] Finalizar Emprestimo");
        ...
        public static void AddBookLoan()
        {
            ...
            catch (UnavailableComicBook ex)
            {
                System.Console.WriteLine(ex.Message);
            }
            catch (MaximumLoansException ex)
            {
                System.Console.WriteLine(ex.Message);
            }
            catch (Exception)
        ...
        public static void EndBookLoan()
        {
            try
            {
                System.Console.Write("Digite o tipo de coleção da revista: ");
                ...
                BookLoan bookLoan = _bookLoanRepository.SearchBookLoanByComicBookParameters(comicBookCollectionType, comicBookYear, comicBookEditionNumber);
                bookLoan.EndLoan();
                _bookLoanRepository.EndLoan(bookLoan);

                System.Console.WriteLine("Empréstimo finalizado com sucesso!");
            }
            catch (BookLoanNotFound ex)
            {
                System.Console.WriteLine(ex.Message);
            }
            catch (ComicBookNotFound ex)
