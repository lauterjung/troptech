    ...
    public class FriendDAO
    {
            ...
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand())
                {
                    ...
                    string sql = @"INSERT INTO Amigos VALUES 
                                    (@nome_amigo, @nome_mae, @telefone, @local_amigo, @tem_livro_emprestado);";
        ...
        public void UpdateFriend(Friend friend)
        {
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    string sql = @"UPDATE Amigos SET 
                                    nome_amigo = @nome_amigo, nome_mae = @nome_mae, telefone = @telefone, local_amigo = @local_amigo, tem_livro_emprestado = @tem_livro_emprestado
                                    WHERE id_amigo = @id_amigo;";

                    command.Parameters.AddWithValue("@id_amigo", friend.FriendId);
        ...
        public Friend SqlToObject(SqlDataReader reader)
        {
            ...
            friend.HasActiveLoan = Convert.ToBoolean(reader["tem_livro_emprestado"]);
        ...
        public void ObjectToSql(Friend friend, SqlCommand command)
        {
            ...
            command.Parameters.AddWithValue("@tem_livro_emprestado", friend.HasActiveLoan);
        }
    }
}