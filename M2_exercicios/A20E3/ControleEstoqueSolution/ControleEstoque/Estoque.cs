...
namespace ControleEstoque
{
    public class Estoque
    {
        ...
        {
            foreach (var p in produtosPreCadastrados)
            {
                p.DefineId(_contadorId++);
            }
        ...
        public bool ProdutoExisteNoEstoque(Produto produto)
        {
            return _produtos.Any(y => y.Equals(produto));
        }
