...
CREATE TABLE ENDERECOESTACIONAMENTO(
ID INT NOT NULL,
...
CREATE CLUSTERED INDEX PK_ID_ENDERECO ON ENDERECOESTACIONAMENTO (ID); 
...
create NONCLUSTERED INDEX IX_NOME_CLIENTE ON CLIENTE (NOME);

INSERT INTO CLIENTE (CPF, NOME, DATANASCIMENTO)
VALUES (59837066082, 'Eduardo', '31-01-2000');
...
create NONCLUSTERED INDEX ix_DATANASCIMENTO_cpf on cliente (DATANASCIMENTO) INCLUDE (Nome, cpf);

DROP INDEX ix_DATANASCIMENTO_cpf ON CLIENTE;
